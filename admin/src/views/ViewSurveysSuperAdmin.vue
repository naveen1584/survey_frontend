...
import superAdminSurveysTable from "@/components/adminComponents/superAdminSurveysTable.vue";
...
<template>
    <SectionMain>
        <SectionTitleBarSub title="Surveys" />
